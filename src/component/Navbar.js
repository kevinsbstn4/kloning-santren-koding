        ...
        return(
            <div>
                <Navbar>
                    ...
                    <Nav className="atas">
                        <NavItem className="tul" onClick={()=> this.props.layout("Kajian")}>
                            <NavLink>
                                Kajian Koding 
                            </NavLink>
                        </NavItem>
                        <NavItem className="tul" onClick={()=> this.props.layout("Mondok")}>
                            <NavLink>
                                Mondok Koding 
                            </NavLink>
                        </NavItem>
                        <NavItem className="tul" onClick={()=>this.props.layout("Kitab")}>
                            <NavLink>
                          Kitab Koding
                                </NavLink>
                                </NavItem>
